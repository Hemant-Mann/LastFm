...
use LastFm\Src\Media as Media;
use LastFm\Src\Album as Album;
use LastFm\Src\Artist as Artist;
use LastFm\Src\PaginatedResult as PaginatedResult;
...
use LastFm\Src\Event as Event;
use LastFm\Src\Shout as Shout;
use LastFm\Src\User as User;
